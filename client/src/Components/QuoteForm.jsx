...
const QuoteForm = () => {
  ...
  return (
    <div className="fixed top-0 right-0 w-[22%] lg:w-[22%] md:w-[30%] sm:w-[50%] h-full bg-white shadow-lg z-50 overflow-y-auto hidden lg:block">
      ...
      >
        ...
        <label className="text-[10px] text-gray-600 flex items-start gap-2">
          ...
          <span>
            ...
            <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">Privacy Policy</a> | 
            <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline"> Terms & Conditions</a>. 
            I Authorize Balaji Kanha Advisors and its representatives to Call, SMS, Email or WhatsApp Me About Its Products and Offers. 
      ...
      <div className="flex justify-center">
        <button className="relative inline-flex items-center justify-center gap-2 px-1 py-2 text-xl font-medium text-white bg-gradient-to-r from-black to-green-600 rounded-md shadow-lg overflow-hidden w-[77%] mt-4">
